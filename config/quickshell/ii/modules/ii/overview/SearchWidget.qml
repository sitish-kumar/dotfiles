...
Item { // Wrapper
    ...
    Rectangle { // Background
        ...
        ColumnLayout {
            ...
            GridView { // Emoji grid (bare emojis, multiple per row; recents first)
                id: emojiGrid
                visible: root.showResults && root.emojiMode
                Layout.fillWidth: true
                implicitHeight: visible ? Math.min(320, contentHeight + topMargin + bottomMargin) : 0
                clip: true
                topMargin: 8
                bottomMargin: 8
                cellWidth: 46
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        color: emojiMouse.containsMouse ? Appearance.colors.colPrimaryContainer : "transparent"
                        Text {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                GlobalStates.overviewOpen = false;  // close so focus returns to the app
                                modelData?.execute();               // then type the emoji into it
                            }
                        }
                    }
                }
