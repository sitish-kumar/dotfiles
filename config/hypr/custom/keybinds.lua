-- ═══════════════════════════════════════════════════════════════════════════
-- Keybinds — this file is the COMPLETE keybind config for your setup.
-- Edit freely here. When this file exists, hyprland/keybinds.lua is skipped
-- entirely so there are no duplicate bindings.
-- Updates never touch this file. Check hyprland/keybinds.lua after an update
-- for any new binds added upstream and copy what you want here.
-- ═══════════════════════════════════════════════════════════════════════════
...
hl.bind("CTRL + SHIFT + ALT + SUPER + Delete", hl.dsp.exec_cmd("systemctl poweroff || loginctl poweroff"),
    { description = "Session: Shut down" }) -- # [hidden]
...
-- ═══════════════════════════════════════════════════════════════════════════
-- Custom additions — add your own keybinds below
-- ═══════════════════════════════════════════════════════════════════════════
...
-- Super + Space: toggle the workspace overview.
